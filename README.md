...
stm32-build|⚠️开发中|STM32 CMake项目编译与烧录助手，支持 CMake/Ninja 构建、OpenOCD ST-Link/J-Link/CMSIS-DAP 烧录、寄存器调试及 Bootloader+APP 双分区烧录|`npx skill add itlantu/itlantu-skills --path skills/stm32-build`
